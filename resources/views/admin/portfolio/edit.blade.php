...
@section('content')
  ...
  <div class="main-panel">
    ...
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
      <div class="card-body">
        <h4 class="card-title">Edit Her Work</h4>
        @if ($errors->any())
    ...
    @endif
        ...
        <form class="forms-sample" method="POST" action="{{ route('admin.portfolio.update', $portfolio->id) }}"
        enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="form-group">
          <p class="card-description"> Her Work Edit</p>
          <div class="row">
          <div class="col-md-5">
